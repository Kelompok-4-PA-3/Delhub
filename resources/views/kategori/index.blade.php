            ...
            <div class="ms-auto">
                <label class="form-check form-switch form-check-reverse">
                    <a class="btn btn-primary btn-sm fw-bold" data-bs-toggle="offcanvas" data-bs-target="#panel_footer"><i
                            class="ph-plus-circle"></i>&nbsp; TAMBAH KATEGORI</a>
                </label>
            </div>
        </div>
                    ...
                    @if ($kategori->count() > 0)
                        @foreach ($kategori as $k)
                            <tr>
                                ...
                                <td>{{ $k->kode_mk }}</td>
                                <td>{{ $k->nama_mk }}</td>
                                <td>{{ $k->kategori ? $k->kategori->nama : '' }}</td>
                                            ...
                                            <div class="mb-3">
                                                <div>
                                                    ...
                                                    <input type="text" name="kode_mk"
                                                        value="{{ old('kode_mk', $k->kode_mk) }}" class="form-control"
                                                        required placeholder="Masukkan kode mk disini">
                                                    @error('kode_mk')
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <input type="text" name="nama_mk"
                                                        value="{{ old('nama_mk', $k->nama_mk) }}" class="form-control"
                                                        required placeholder="Masukkan nama mk disini">
                                                    @error('nama_mk')
                                                        <div class="text-danger text-sm p-1"><i
                                                                class="ph-warning-circle"></i>{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <input type="text" name="nama_singkat"
                                                        value="{{ old('nama_singkat', $k->nama_singkat) }}"
                                                        class="form-control" required
                                                        placeholder="Masukkan nama singkat disini">
                                                    @error('nama_singkat')
                                                        <div class="text-danger text-sm p-1"><i
                                                                class="ph-warning-circle"></i>{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <select type="text" name="kategori_proyek" class="form-control"
                                                        required>
                                                        <option value="">Pilih kategori proyek</option>
                                                        @foreach ($kategori_proyek as $kp)
                                                            <option value="{{ $kp->id }}"
                                                                {{ $kp->id == $k->kategori_proyek ? 'selected' : '' }}>
                                                                {{ $kp->nama }}</option>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Apakah anda yakin ingin menghapus data <span
                                                class="fw-semibold">{{ $k->nama_mk }}</span> ?
                                        </div>
                ...
                <form action="/kategori" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="mt-2">
                                <label class="form-label">Kode</label>
                                <input type="text" name="kode_mk" value="{{ old('kode_mk') }}" class="form-control"
                                    required placeholder="Masukkan kode mk disini">
                                @error('kode_mk')
                            ...
                            <div class="mt-2">
                                <label class="form-label">Nama</label>
                                <input type="text" name="nama_mk" value="{{ old('nama_mk') }}" class="form-control"
                                    required placeholder="Masukkan nama mk disini">
                                @error('nama_mk')
                                    <div class="text-danger text-sm p-1"><i class="ph-warning-circle"></i>{{ $message }}
                                    </div>
                            ...
                            <div class="mt-2">
                                <label class="form-label">Nama Singkat</label>
                                <input type="text" name="nama_singkat" value="{{ old('nama_singkat') }}"
                                    class="form-control" required placeholder="Masukkan nama singkat disini">
                                @error('nama_singkat')
                                    <div class="text-danger text-sm p-1"><i class="ph-warning-circle"></i>{{ $message }}
                                    </div>
                                @enderror
                            ...
                            <div class="mt-2">
                                ...
                                <select type="text" name="kategori_proyek" class="form-control" required>
                                    ...
                                    @foreach ($kategori_proyek as $kp)
                                        <option value="{{ $kp->id }}"
                                            {{ $kp->id == old('kategori_id') ? 'selected' : '' }}>{{ $kp->nama }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('nama')
