                    ...
                    <form action="/users" method="post">
                        ...
                        <fieldset class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="nama" type="text" class="form-control" value="{{old('nama')}}" placeholder="Masukkan nama disini" required>
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <input name="username" type="text" class="form-control" value="{{old('username')}}" placeholder="Masukkan username disini">
                                @error('username')
                                    <div class="text-danger text-sm p-1"><i class="ph-warning-circle"></i>{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="email" type="text" class="form-control" value="{{old('email')}}" placeholder="Masukkan email disini">
                                @error('email')
                                    <div class="text-danger text-sm p-1"><i class="ph-warning-circle"></i>{{$message}}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <select data-placeholder="Pilih role..." id="permission_select" multiple="multiple" name="roles[]" class="form-control select select-disabled" required   @if($roles->count() <= 0) disabled  @endif>
                                    {{-- <option></option> --}}
                                    <optgroup label="Daftar Role">
                                        @foreach($roles as $r)
                                            <option {{ in_array($r->name, old('roles', [])) ? 'selected' : '' }} value="{{$r->name}}">{{$r->name}}</option>
                                        @endforeach
                                    </optgroup>
                                </select>
                                @if($roles->count() <= 0) 
                            ...
                            <div class="mb-3">
                                ...
                                <input name="password" type="password" class="form-control" value="{{old('password')}}" placeholder="Masukkan password disini">
                                @error('password')
                                    <div class="text-danger text-sm p-1"><i class="ph-warning-circle"></i>{{$message}}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="password_confirmation" class="form-control" value="{{old('password_confirmation')}}" placeholder="Konfirmasi password disini">
