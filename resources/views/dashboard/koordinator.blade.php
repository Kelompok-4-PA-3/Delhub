                                ...
                                <div class="p-1">
                                    <div class="d-flex mb-2">
                                        ...
                                        <div>
                                            ...
                                            @if ($k->topik != null)
                                                <span class="text-muted" data-bs-popup="tooltip"
                                                    title="{{ $k->topik }}">{{ Str::limit($k->topik, 30) }}</span>
                                            @else
                                                <small class="text-nowrap text-warning"><i class="ph-warning-circle"></i>
                                                    Belum ada
                                                    topik </small>
                                            @endif
                                        </div>
    ...
    <div class="sidebar sidebar-end sidebar-expand-lg sidebar-collapsed">
        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-2">
                ...
                <div class="ms-auto">
                    <button type="button"
                        class="btn btn-light border-transparent btn-icon rounded-pill btn-sm sidebar-control sidebar-end-toggle d-none d-lg-inline-flex">
                    ...
                    <ul class="nav nav-sidebar mt-2" data-nav-type="accordion">
                                ...
                                <div class="dropdown-menu">
                                    <form action="/kelompok" class="container" method="post">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input type="number" class="w-100 form-control form-control-sm"
                                                name="jumlah_kelompok" required>
                                            <input type="text"
                                                value="{{ $krs->kategori ? $krs->kategori->nama_singkat : '' }}"
                                                name="krs_name" class="d-none">
                                            <input type="text" value="{{ $krs->id }}" name="krs_id"
                                                class="d-none">
                                        </div>
                                        <div class="d-flex mt-2">
                                            <button type="submit"
                                                class="badge ms-auto bg-primary border border-0">Buat</button>
                                        </div>
                        ...
                        <li class="nav-item">
                            <a href="/krs/{{ $krs->id }}/regulasi" class="nav-link">
                                <i class="ph-device-tablet-speaker me-2"></i>
                                Regulasi
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="/krs/{{ $krs->id }}/submission" class="nav-link">
                        ...
                        <div class="sidebar-content tab-content">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex mb-3">
                                                        ...
                                                        <div class="flex-fill">
                                                            <a href="#"
                                                                class="fw-semibold">{{ $k->mahasiswa ? $k->mahasiswa->user->nama : '' }}</a>
                            ...
                            <div class="tab-pane fade active" id="tambah-user">
                                <form action="/users/krs/add" method="post">
                                    ...
                                    <select data-placeholder="Pilih mahasiswa" multiple="multiple"
                                        id="permission_select_edit" name="mahasiswa[]" class="form-control select"
                                        required @if ($mahasiswa->count() <= 0) disabled @endif>
                                        <option></option>
                                        <optgroup label="Daftar Mahasiswa">
                                            @foreach ($mahasiswa as $m)
                                                @if (!in_array($m->user_id, $krs->krs_user->pluck('user_id')->toArray()))
                                                    <option value="{{ $m->user ? $m->user->id : '' }}">
                                                        {{ $m->user ? $m->user->nama : '' }}
                                                    </option>
                                                @endif
                                            @endforeach
                                    ...
                                    @if ($mahasiswa->count() < 0)
                                        <small class="text-danger">Tidak ada data mahasiswa
                                            ditemukan</small>
                                    @endif
                                    <div class="py-2">
