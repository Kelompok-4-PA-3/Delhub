					...
					<div class="p-1">
						<div class="d-flex mb-2">
							...
							<div>
								...
								@if ($k->topik != NULL)
								<span class="text-muted" data-bs-popup="tooltip" title="{{$k->topik}}">{{ Str::limit
									($k->topik, 30) }}</span>
								@else
								<small class="text-nowrap text-warning"><i class="ph-warning-circle"></i> Belum ada
									topik </small>
								@endif
							</div>
						</div>
							...
							<div class="dropdown-menu">
								<form action="/kelompok" class="container" method="post">
									...
									<div class="d-flex">
										...
										<input type="text" value="{{$krs->kategori->nama_singkat}}" name="krs_name"
											class="d-none">
									...
									<tr>
										<td>
											<div class="d-flex mb-3">
												<a href="#" class="me-3">
													<img src="../../../assets/images/demo/users/face1.jpg" width="36"
														height="36" class="rounded-pill" alt="">
												</a>
												<div class="flex-fill">
						...
						<div class="tab-pane fade active" id="tambah-user">
							<form action="/users/krs/add" method="post">
								...
								<select data-placeholder="Pilih mahasiswa" multiple="multiple"
									id="permission_select_edit" name="mahasiswa[]" class="form-control select" required
								...
								@if($mahasiswa->count() < 0) <small class="text-danger">Tidak ada data mahasiswa
									ditemukan</small>
									@endif
									<div class="py-2">
