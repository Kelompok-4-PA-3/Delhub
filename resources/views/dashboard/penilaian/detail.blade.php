    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                ...
                $status_nilai = true;
                if
                ($penilaian->nilai_mahasiswa_kelompok($kelompok->id)->where('role_dosen_kelompok_id',$role_dosen->id)->where('approved_status',false)->count()
                > 0 ||
                $penilaian->nilai_mahasiswa_kelompok($kelompok->id)->where('role_dosen_kelompok_id',$role_dosen->id)->count()
                < 1) { $status_nilai=false; } @endphp {{-- {{$penilaian->nilai_mahasiswa_kelompok($kelompok->id)->wher
            ...
            <div class="card-body table-responsive">
                <div>
                    ...
                    @if (!$status_nilai)
                    <i class="fs-sm me-2"><i class="ph-warning-circle text-info"></i> Klik kolom table untuk memasukkan
                        nilai mahasiswa</i>
                    @else
                    <i class="fs-sm"><i class="ph-warning text-warning"></i> Jika nilai sudah diapprove anda tidak dapat
                ...
                <table class="table datatable-hasil-nilai w-100 scrollable-table table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @endphp
                            @foreach ($penilaian->komponen_penilaian as $pkp)
                            <td class="{{!$status_nilai ? 'add_nilai text-primary' : ''}}" data-name="komponen"
                                data-pkp_id="{{$pkp->id}}" data-mahasiswa={{$kkm->mahasiswa->nim}}
                                data-type="number"
                                data-max="100"
                                data-min="0"
                                @if ($status_nilai)
