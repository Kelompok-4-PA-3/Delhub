                ...
                <div class="mt-2 ms-auto">
                    @if (Gate::check('is_pembimbing', $kelompok))
                        <form action="/krs/{{ $kelompok->krs->id }}/hasil_penilaian" method="get">
                            ...
                            <button type="submit" class="btn btn-sm btn-indigo fw-light fs-sm fw-semibold"> Hasil nilai
                                mahasiswa</button>
                        </form>
                    @endif
                </div>
                ...
                @else
                    <table class="table">
                        ...
                        <div class="fw-semibold d-flex">
                            <a @if ($role_dosen->role_group->komponen_penilaian->where('is_verified', false)->count() > 0 || $role_dosen->role_group->komponen_penilaian->count() <= 0) @else
                            ...
                            @if ($role_dosen->role_group->komponen_penilaian->where('is_verified', false)->count() > 0 || $role_dosen->role_group->komponen_penilaian->count() <= 0) <a href="#"
                                    ...
                                    <th>
                                        @if ($rr->poin_penilaian != null)
                                            <div class="fw-semibold d-flex">
                                                <a
                                                    @if (
                                                        $rr->poin_penilaian->komponen_penilaian->where('is_verified', false)->count() <= 0 &&
                                                            $rr->poin_penilaian->komponen_penilaian->count() > 0 &&
                                                            $rr->poin_penilaian->role_group_penilaian->where('is_verified', false)->count() <= 0) href="/kelompok/{{ $kelompok->id }}/penilaian/role/{{ $role_dosen->id }}/{{ $rr->poin_penilaian->id }}" @endif>
                                                ...
                                                @if (
                                                    ...
                                                    <a href="#" class="ph-warning-circle px-1 text-warning"
                                        ...
                                        @else
                                            <small> {{ $rr }} ( <i>Belum memiliki komponen penilaian</i>
                                                )</small>
                                        @endif
                                    </th>
                                @endforeach
                            ...
                            <div class="modal-dialog modal-xs">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <form
                                            action="/kelompok/{{ $kelompok->id }}/penilaian/role/{{ $role_dosen->id }}/approved"
                                            method="post">
                                            @csrf
