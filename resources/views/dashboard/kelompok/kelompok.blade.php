                    ...
                    <div class="tab-content flex-lg-fill">
                        <div class="tab-pane fade show" id="edit_pembimbing_penguji">
                            <form action="{{ Route('kelompok_role.add', ['kelompok' => $kelompok->id]) }}" method="post">
                                @csrf
                                <div class="py-1">
                                    <select data-placeholder="Pilih dosen" name="nidn" class="form-control select"
                                        required>
                                        <option></option>
                                            ...
                                            @foreach ($kelompok->krs->kategori_role_get_role as $kkk)
                                                @if (!in_array($kkk->id, $kelompok->role_kelompok->pluck('role_group_id')->toArray()))
                                                    <option value="{{ $kkk->id }}">{{ Str::limit($kkk->nama, 30) }}
                                                        <span
                                                            class="text-primary">{{ $kkk->is_main ? ' - wajib' : '' }}</span>
                                                    </option>
                                                @endif
                                            @endforeach
                                        </optgroup>
                                ...
                                @if ($kelompok->role_kelompok->count() > 0)
                                    @if (!$verified)
                                        <div>
                                            <div class="d-flex">
                                                ...
                                                @if (Auth::user()->dosen->nidn == $kelompok->krs->dosen_mk || Auth::user()->dosen->nidn == $kelompok->krs->dosen_mk_2)
                                                    <div class="ms-auto">
                                                        <form action="/kelompok/{{ $kelompok->id }}/verfikasi/role"
                                                            method="post">
                                                            @csrf
                                    ...
                                    @else
                                        <div class="d-flex">
                                            @if (Auth::user()->dosen->nidn == $kelompok->krs->dosen_mk || Auth::user()->dosen->nidn == $kelompok->krs->dosen_mk_2)
                                                <span
                                                    class="text-primary text-success p-1 px-3 rounded-pill fw-semibold mt-1"><i
                                ...
                                @foreach ($kelompok->role_kelompok as $kr)
                                    <div>
                                        <div class="d-flex px-2 mt-2">
                                            <small
                                                class="text-muted">{{ $kr->role_group != null ? $kr->role_group->nama : '' }}
                                            </small>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div>
                                                                            ...
                                                                            @if ($kb->reference->value == 'waiting')
                                                                                @foreach ($status_bimbingan as $sb)
                                                                                    <a href="/bimbingan/status/{{ $sb->id }}/{{ $kb->id }}"
                                                                                        ...
                                                                                        @if ($sb->value == 'approve')
                                                                                            <i
                                                                                                class="ph-checks text-success me-2"></i>
                                                                                        @elseif($sb->value == 'reject')
                                                                                            <i
                                                                                                class="ph-x text-danger me-2"></i>
                                                                                        @elseif($sb->value == 'reschedule')
                                                                                            <i
                                                                                                class="ph-calendar-x text-info me-2"></i>
                                                                                        @endif
                                                                                        {{ $sb->value }}
                                                                                    </a>
                                                                                @endforeach
                                                                        ...
                                                                        @role('mahasiswa')
                                                                            @if ($kb->reference->value == 'approve' && !$kb->is_done)
                                                                                <a href="#" class="dropdown-item"
                                                                                    ...
                                                                                    <i
                                                                                        class="ph-microsoft-excel-logo me-2"></i>
                                                                                    Hasil bimbingan
                                                                                </a>
                                                                            @endif
                                                                        @endrole
                                                ...
                                                <div id="modal_detail{{ $kb->id }}" class="modal fade"
                                                    tabindex="-1">
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                @if ($kb->is_done)
                                                                    <div
                                                                        class=" bg-primary bg-opacity-10 rounded p-2 d-flex">
                                                                        <small>
                                                                            {!! $kb->hasil !!}
                                                                        </small>
                                                                    </div>
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                ...
                                                                <div class="ms-auto">
                                                                    ...
                                                                    @else
                                                                        <div>
                                                                            <i
                                                                                class="ph-circle-wavy-check text-success"></i>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                ...
                                                <div id="upload_bukti{{ $kb->id }}"
                                                    ...
                                                    <div class="offcanvas-body">
                                                        ...
                                                        @if ($kb->hasil == null)
                                                            <form action="/bimbingan/upload/{{ $kb->id }}"
                                                                method="post" enctype="multipart/form-data">
                                                                @csrf
                                                                <div class="mt-2">
                                                                    <label class="form-label">Hasil bimbingan</label>
                                                                    <textarea class="form-control" id="ckeditor_classic_edit{{ $kb->id }}" name="hasil"
                                                                        placeholder="Masukkan komponen penilaian anda disini..." required>{{ old('komponen_penilaian', $kb->komponen_penilaian) }}</textarea>
                                                                    @error('komponen_penilaian')
                                                                        <div class="text-danger text-sm p-1"><i
                                                                                class="ph-warning-circle"></i>{{ $message }}
                                                                        </div>
                                                                    @enderror
                                                                </div>
                                                ...
                                                <div class="d-flex align-items-center mx-md-1">
                                                    ...
                                                    <span class="d-none d-md-inline-block ms-2">{{$kb->hasil}}</span>
                                                                ...
                                                                @role('mahasiswa')
                                                                    <div class="ms-auto">
                                                                        <small class="fw-light" data-bs-toggle="modal"
                                                                            data-bs-target="#modal_hapus{{ $kb->id }}_file"><a
                                                                                href="#"
                                                            ...
                                                            @role('dosen')
                                                                <form action="/bimbingan/approve/{{ $kb->id }}"
                                                                    method="post" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="border-top p-3">
                                                                        <button type="submit"
                                                ...
                                                <!-- Delete Modal -->
                                                <div id="modal_hapus{{ $kb->id }}_file" class="modal fade"
                                                    tabindex="-1">
                                                    <div class="modal-dialog modal-xs">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"><i
                                                                        class="ph-warning text-warning"></i>
                                                                    Konfirmasi</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal"></button>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                <button type="button" class="btn btn-light"
                                                                    data-bs-dismiss="modal">Batal</button>
                                                                <form action="/request/{{ $kb->id }}/delete-file"
                                                                    method="post">
                                                                    @csrf
                                                ...
                                                <!-- Delete Modal -->
                                                <div id="modal_hapus{{ $kb->id }}" class="modal fade"
                                                    tabindex="-1">
                                                    <div class="modal-dialog modal-xs">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                            ...
                            <div class="tab-pane fade" id="tambah-bimbingan">
                                <form action="/bimbingan" method="post">
                                    ...
                                    <div class="p-1">
                                        ...
                                        <select class="form-control" name="ruangan_id" placeholder="waktu bimbingan"
                                            required>
