            ...
            <li class="nav-item">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="list-group">
                        <div class="d-flex">
                            <a @if ($myrole->is_verified) href="/kelompok/{{ $kelompok->id }}/penilaian/role/{{
                                $myrole->id }}" @endif
    ...
    <div class="col-xl-7">
                ...
                <div class="tab-content flex-lg-fill">
                    <div class="tab-pane fade show active" id="topik-proyek">
                        <div class="d-flex">
                            ...
                            <div class="ms-auto">
                                <form action="/kelompok/{{$kelompok->id}}/approved_topik" method="POST">
                                    @csrf
                                    <input type="hidden" value="{{$kelompok->id}}" name="kelompok">
                                    <button href="" class="badge bg-success fw-light border-0">Approve</button>
                                </form>
                            </div>
                            @endif
                            @endrole
                        ...
                        @else
                        <h5 class="fw-semibold p-2 {{!$kelompok->topik_approved ? 'text-warning' : ''}}">{{
                            $kelompok->topik }}</h5>
                        <i> {!! !$kelompok->topik_approved ? '<i class="ph-warning-circle text-info"></i> belum
                            diapprove! ' : '<i class="ph-checks text-success"></i> sudah diapprove! '!!}</i>
                        @endif
                    </div>
                    ...
                    <div class="tab-pane fade" id="edit-topik">
                        <form action="/kelompok/topik" method="post">
                            ...
                            <input type="text" class="form-control" name="topik"
                                value="{{ old('topik', $kelompok->topik) }}" placeholder="Masukkan topik disini"
                                required>
                            <div class="p-1">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><span class="fw-semibold">{{ $km->mahasiswa->nim }}</span> - {{ $km->mahasiswa->user->nama }}
                </p>
                @endforeach
            </div>
        </div>
                            ...
                            <div class="py-1">
                                <select data-placeholder="Pilih dosen" name="nidn" class="form-control select" required>
                                    ...
                                    <optgroup label="Daftar Dosen">
                                        @foreach ($dosen as $d)
                                        <option value="{{ $d->nidn }}">{{ Str::limit($d->user->nama, 30) }}
                                        </option>
                                        @endforeach
                                    </optgroup>
                                </select>
                            ...
                            <div class="py-1">
                                <select name="role_group_id" class="form-control" required>
                                    <optgroup label="Daftar role">
                                        ...
                                        <option value="{{ $kkk->id }}">{{ Str::limit($kkk->nama, 30) }}
                                            <span class="text-primary">{{ $kkk->is_main ? ' - wajib' : '' }}</span>
                                        </option>
                                        @endif
                                        @endforeach
                                    </optgroup>
                                ...
                                <div class="ms-auto">
                                    <form action="/kelompok/{{ $kelompok->id }}/verfikasi/role" method="post">
                                        ...
                                        <button class="btn btn-primary btn-sm fw-semibold ms-auto"><i
                                                class="ph-circle-wavy-warning"></i>&nbsp;
                                            Verifikasi&nbsp;&nbsp;&nbsp;
                                            <span class="bg-warning px-1 fw-semibold">{{
                                                $kelompok->role_kelompok->count() }}</span></button>
                                    </form>
                                </div>
                                @endif
                            </div>
...
<div class="col-xl-5">
                ...
                <div class="tab-pane fade" id="tambah-bimbingan">
                    <form action="/bimbingan" method="post">
                        ...
                        <div class="p-1">
                            ...
                            <input class="form-control" value="{{ old('deskripsi') }}" name="waktu"
                                type="datetime-local" placeholder="waktu bimbingan" required>
                        </div>
                        <div class="p-1">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="p-2 w-100 border border-1 rounded mb-2">
                ...
                // $path = '/public/file-template/' . $d->file_template;
    ...
    <div class="card">
        <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
            <h5 class="py-sm-2 my-sm-1">Feedback </h5><br>
        </div>
        <div class="card-body">
            @foreach ($kelompok->krs->kategori->kategori->poin_regulasi as $krs_kategori)
            <div class="border border-1 rounded mb-2">
                <div class="d-flex p-3">
                    <div class="">
                        <h5 class="fw-semibold m-0">{{$krs_kategori->nama}}</h5>
                        <small class="text-muted">Daftar list feedback saat {{strtolower($krs_kategori->nama)}}</small>
                    </div>
                    <div class="ms-auto">
                        <a class="btn btn-primary" data-bs-toggle="offcanvas"
                            data-bs-target="#feedback_panel_{{$krs_kategori->id}}"><i class="ph-pencil"></i></a>
                    </div>
                </div>
            </div>
            @endforeach
            {{-- <div class="btn-group">
                <a href="#" class="badge fw-light bg-primary btn-sm dropdown-toggle" data-bs-toggle="dropdown"><i
                        class="ph-list-checks"></i> Tambahkan feedback</a>

                <div class="dropdown-menu">
                    @foreach ($kelompok->krs->kategori->kategori->poin_regulasi as $kategori_krs)
                    <a href="#" class="dropdown-item" data-bs-toggle="offcanvas"
                        data-bs-target="#feedback_panel_{{$kategori_krs->id}}">{{$kategori_krs->nama}}</a>
                    @endforeach
                </div>
            </div> --}}
            ...
            {{-- <div>
                <a class="badge btn-sm bg-primary fw-light" href="" data-bs-toggle="offcanvas"
                    data-bs-target="#feedback_panel"><i class="ph-list-checks"></i> Tambahkan feedback</a>
            </div> --}}
            <div>
                <div></div>
            </div>
    ...
    @foreach ($kelompok->krs->kategori->kategori->poin_regulasi as $kategori_krs)
    <!-- Large panel -->
    <div id="feedback_panel_{{$kategori_krs->id}}"
        class="offcanvas offcanvas-end offcanvas-size-lg {{session()->has('feedback_session') ? 'show' : ''}}"
        tabindex="-1" style="width: 65%;">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title fw-semibold">Feedback {{$kategori_krs->nama}}</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
        </div>
        ...
        <div class="offcanvas-body p-0">
            <div class="container">
                ...
                <ul class="nav nav-tabs nav-tabs-underline nav-justified">
                    <li class="nav-item">
                        <a href="#list-feedback{{$kategori_krs->id}}" class="nav-link active" data-bs-toggle="tab">
                            Daftar
                        </a>
                    </li>
                    @role(['dosen','admin'])
                    @if (Gate::check('is_pembimbing', $kelompok) || Auth::user()->hasRole('admin'))
                    <li class="nav-item">
                        <a href="#tambah-feedback{{$kategori_krs->id}}" class="nav-link" data-bs-toggle="tab">
                            Request
                        </a>
                    </li>
                    @endif
                ...
                <div class="tab-content card-body">
                    <div class="tab-pane active fade show active" id="list-feedback{{$kategori_krs->id}}">
                        <div class="py-3">
                            <div class="feedback_list">
                                <table class="table table-bordered datatable-penilaian">
                                    <thead>
                                        <tr>
                                            <th>Poin feedback</th>
                                            <th>Status</th>
                                    ...
                                    <tbody>
                                        @if ($feedback->where('poin_regulasi_id',$kategori_krs->id)->count() > 0)
                                        @foreach ($feedback->where('poin_regulasi_id',$kategori_krs->id) as $f)
                                        <tr>
                                            <td>
                                                {!!$f->feedback!!}
                                            </td>
                                            <td class="" width="25">
                                                <div>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <form
                                                                action="/kelompok/{{$kelompok->id}}/feedback/{{$f->id}}/status"
                                                                method="POST" id="form-success" class="m-0">
                                                                @csrf
                                                                <input type="hidden" name="status" value="1">
                                                                <a onclick="document.getElementById('form-success').submit();"
                                                                    href="#" class="dropdown-item"><i
                                                                        class="text-success ph-checks"></i>
                                                                    &nbsp;Terpenuhi</a>
                                                            </form>
                                                            <form
                                                                action="/kelompok/{{$kelompok->id}}/feedback/{{$f->id}}/status"
                                                                method="POST" id="form-warning" class="m-0">
                                                                @csrf
                                                                <input type="hidden" name="status" value="2">
                                                                <a onclick="document.getElementById('form-warning').submit();"
                                                                    href="#" class="dropdown-item"><i
                                                                        class="text-warning ph-warning-circle"></i>
                                                                    &nbsp;Sebagian</a>
                                                            </form>
                                                            <form
                                                                action="/kelompok/{{$kelompok->id}}/feedback/{{$f->id}}/status"
                                                                method="POST" id="form-danger" class="m-0">
                                                                @csrf
                                                                <input type="hidden" name="status" value="3">
                                                                <a onclick="document.getElementById('form-danger').submit();"
                                                                    href="#" class="dropdown-item"><i
                                                                        class="text-danger ph-x-circle"></i>
                                                                    &nbsp;Belum</a>
                                                            </form>
                                                        </div>
                                                    </div>
                                                    ...
                                                    @else
                                                    <span
                                                        class="bg-secondary text-secondary fw-semibold fs-sm bg-opacity-10 p-1 px-2 rounded-pill">progress</span>
                                                    @endif
                                                    @else
                                                    <span
                                                        class="bg-secondary text-secondary fw-semibold fs-sm bg-opacity-10 p-1 px-2 rounded-pill">progress</span>
                                            ...
                                            <td class="text-center"  width="25">
                                                <div class="btn-group">
                                                    <a href="#" class="text-body mx-2" data-bs-popup="tooltip"
                                                        title="hapus" data-bs-toggle="dropdown">
                                                        <i class="ph-trash"></i>
                                                    </a>
                                                    <div class="dropdown-menu p-2">
                                                        <div>
                                                            <i>Apakah anda yakin ingin menghapus data bimbingan ini ?</i>
                                                        </div>
                                                        <form
                                                            action="/kelompok/{{$kelompok->id}}/feedback/{{$f->id}}/delete"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit"
                                                                class="badge border-0 bg-success">Ya</button>
                                                            <button type="submit"
                                                                class="badge border-0 bg-danger">Tidak</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <th colspan="3" class="text-center">
                                                <small class="text-muted fw-light"><i>Belum ada feedback yang
                                                        dibuat!</i></small>
                                            </th>
                                        </tr>
                                        @endif
                    ...
                    @role(['dosen','admin'])
                    @if (Gate::check('is_pembimbing', $kelompok))
                    <div class="tab-pane fade show" id="tambah-feedback{{$kategori_krs->id}}">
                        <div class="py-3">
                            <form action="/kelompok/{{$kelompok->id}}/feedback" method="POST">
                                @csrf
                                <input type="hidden" name="poin_regulasi_id" value="{{$kategori_krs->id}}">
                                <div>
                                    <textarea class="form-control feedback_input" id="ckeditor_classic_edit{{$kategori_krs->id}}"
                                        name="feedback" placeholder="Masukkan feedback anda disini..."></textarea>
                                </div>
                                <div class="py-2">
    ...
    <script>
        ...
        CKEDITOR.replace('ckeditor_classic_edit{{$kategori_krs->id}}', {
            toolbar: 'Basic'
        });
    </script>
    @endforeach
...
<script>
    // $('.bimbingan_list').hide();
        ...
        // Function to initialize CKEditor Classic for textareas
function initializeCodeEditors() {
  var textareas = document.querySelectorAll('.ckeditor_classic_empty');
...
window.addEventListener('DOMContentLoaded', initializeCodeEditors);
</script>
