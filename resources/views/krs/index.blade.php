    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            ...
            <div class="ms-auto">
                <label class="form-check form-switch form-check-reverse">
                    <a href="/krs/create" class="btn btn-primary btn-sm fw-bold"><i class="ph-plus-circle"></i>&nbsp; TAMBAH
                        KRS</a>
                </label>
            </div>
        </div>
        ...
        <div class="card-body pb-0">
            ...
            <div class="card-body table-responsive">
                <table class="table datatable-hasil-nilai scrollable-table">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Kategori</th>
                    ...
                    <tbody>
                        @foreach ($krs as $k)
                            <tr>
                                ...
                                <td> <a href="/koordinator/proyeksaya/{{ $k->id }}">{{ $k->kategori->nama_mk }}</a>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="d-inline-flex">
                                        <a href="/krs/{{ $k->id }}/edit" class="text-body" data-bs-popup="tooltip"
                                            title="Ubah">
                                            <i class="ph-pen"></i>
                                        </a>
