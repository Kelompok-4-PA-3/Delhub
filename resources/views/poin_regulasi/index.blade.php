                    ...
                    <tbody>
                        @foreach ($poin_regulasi as $pr)
                            <tr>
                                ...
                                <td>{{ $pr->nama }}</td>
                                <td>{{ $pr->poin }}</td>
                                <td>{{ $pr->kategori_proyek ? $pr->kategori_proyek->nama : '' }}</td>
                                            ...
                                            <div class="mb-3">
                                                <div class="mt-2">
                                                    ...
                                                    <input type="text" name="nama_edit"
                                                        value="{{ old('nama_edit', $pr->nama) }}" class="form-control"
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <input
                                                            class="form-control form-control-sm form-control-number text-center"
                                                            type="number" name="poin"
                                                            value="{{ old('poin', $pr->poin) }}" min="0">
                                                        <button type="button" class="btn btn-sm btn-light btn-icon"
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <select type="text" name="kategori_id" class="form-control"
                                                        required placeholder="Masukkan kategori_id disini">
                                                        <option value="">Pilih kategori proyek</option>
                                                        @foreach ($kategori_proyek as $kp)
                                                            <option value="{{ $kp->id }}"
                                                                {{ $kp->id == $pr->kategori_id ? 'selected' : '' }}>
                                                                {{ $kp->nama }}</option>
                                                        @endforeach
                                                    </select>
                                                    @error('nama')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input class="form-control form-control-sm form-control-number text-center"
                                        type="number" name="poin" value="{{ old('poin', 0) }}" min="0">
                                    <button type="button" class="btn btn-sm btn-light btn-icon"
                                        onclick="this.parentNode.querySelector('input[type=number]').stepUp()">
                                        <i class="ph-plus ph-sm"></i>
                                    </button>
                            ...
                            <div class="mt-2">
                                <label class="form-label">Kategori Proyek</label>
                                <select type="text" name="kategori_id" value="{{ old('kategori_id') }}"
                                    class="form-control" required placeholder="Masukkan kategori_id disini">
                                    <option value="">Pilih kategori proyek</option>
                                    @foreach ($kategori_proyek as $kp)
