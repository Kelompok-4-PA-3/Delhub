<!-- Main sidebar -->
<div class="sidebar sidebar-light sidebar-main sidebar-expand-lg border-0"
        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @role('mahasiswa')
                    ...
                    @foreach (Auth::user()->mahasiswa->kelompok_mahasiswas->take(3) as $km)
                ...
                {{Auth::user()->dosen->pembimbing_2}} --}}
                    @if (Auth::user()->dosen->all_role_kelompok->count() > 0)
                        ...
                        @endforeach
                        <li class="nav-item-header">
                            <div class="fs-sm lh-sm opacity-50 sidebar-resize-hide ml-2"><i><a href="/dashboard"
                                        class="text-light ">Pekerjaan lainnya ...</a></i></div>
                        </li>
                    @endif
                ...
                @role('admin')
                    <li class="nav-item nav-item-submenu ">
                        ...
                        <ul class="nav-group-sub collapse">
                            ...
                            <li class="nav-item-header pt-0">
                                <div class="text-uppercase fs-sm lh-sm opacity-50 sidebar-resize-hide">civitas dan Program
                                    pendidikan</div>
                                <i class="ph-dots-three sidebar-resize-show"></i>
                            </li>
                            @can('manajemen dosen')
